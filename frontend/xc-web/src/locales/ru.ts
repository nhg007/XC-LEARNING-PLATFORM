export default {
  ...
  practice: {
    ...
    audioWaveform: 'Прогресс аудио',
    seekAudio: 'Перейти к {percent}%',
  ...
  classroom: {
    title: 'Классы',
    subtitle: 'Введите код приглашения от учителя, чтобы вступить в класс и увидеть информацию, контакт учителя и участников.',
    joinTitle: 'Вступить в класс',
    joinHint: 'Получите код приглашения у учителя. Создание классов, проверка участников и управление кодами выполняются в кабинете учителя.',
    inviteCode: 'Код приглашения',
    join: 'Вступить',
    myRooms: 'Мои классы',
    roomCount: 'Классов: {count}',
    ...
    noTeacherContact: 'Контакта пока нет',

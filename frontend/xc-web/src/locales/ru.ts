export default {
  ...
  vocab: {
    ...
    favoritesSubtitle: 'Сохраненные слова и предложения разложены по группам.',
    favoriteCount: 'Сохранено слов: {count}',
    favoriteTotalCount: 'В избранном: {count}',
    favoriteWords: 'Слова',
    favoriteSentences: 'Предложения',
    pageSummary: 'Страница {page} / {pages} · {pageSize} на странице · всего {total}',
    emptyFavorites: 'Избранного пока нет.',
    emptyFavoriteWords: 'Сохраненных слов пока нет. Нажмите «В избранное» во время повторения слов.',
    emptyFavoriteSentences: 'Сохраненных предложений пока нет. Нажмите «В избранное» во время практики.',
  ...
  elimination: {
    ...
    points: 'баллы',
    setup: 'Выбор уровня',
    setupDesc: 'Выберите источник слов, перевод, пиньинь и группу, затем уровень.',
  ...
  membership: {
    ...
    offlineTitle: 'Оплата офлайн',
    offlineSubtitle: 'Рекомендуем WeChat Pay или Alipay',
    offlineHint: 'После оплаты отправьте email аккаунта, тариф и скриншот платежа в Telegram, WhatsApp или VK. Мы активируем подписку после проверки.',
    offlineMethodsTitle: 'Рекомендуемые способы',
    offlineContactTitle: 'Контакты для активации',
    offlineQrMissing: 'Свяжитесь с нами, чтобы получить QR-код оплаты',
    copyContact: 'Копировать',
    contactCopied: 'Контакт скопирован',
    copyFailed: 'Не удалось скопировать. Скопируйте вручную.',
    footerTitle: 'Оплатите офлайн и напишите для активации',
    footerSubtitle: 'Поддерживаются WeChat Pay и Alipay. Также можно связаться через Telegram, WhatsApp или VK.',
    footerOpenMembership: 'Оплата',
  ...
  records: {
    ...
    memberTitle: 'История обучения: {name}',
    memberSubtitle: 'Создатель класса может смотреть отчеты, ежедневную статистику и ответы участника.',
  ...
  classroom: {
    title: 'Классы',
    subtitle: 'Создавайте свои классы или вступайте по коду приглашения, чтобы видеть участников и учебные записи.',
    createTitle: 'Создать класс',
    createHint: 'Любой зарегистрированный пользователь может создать класс. Поделитесь кодом приглашения, чтобы другие вступили.',
    className: 'Название класса',
    classDescription: 'Описание класса',
    create: 'Создать',
    joinTitle: 'Вступить в класс',
    joinHint: 'Введите код приглашения, которым с вами поделились, чтобы сразу вступить.',
    inviteCode: 'Код приглашения',
    copyInvite: 'Копировать код',
    join: 'Вступить',
    myRooms: 'Мои классы',
    roomCount: 'Классов: {count}',
    createdByMe: 'Создан мной',
    joinedByMe: 'Участник',
    emptyRooms: 'Нет классов',
    chooseRoom: 'Выберите класс',
    noDescription: 'Нет описания',
    owner: 'Создатель',
    ownerLine: 'Создатель: {name}',
    noOwner: 'Создатель не указан',
    noOwnerContact: 'Контакта пока нет',
    inviteHint: 'Поделитесь кодом, чтобы одноклассники могли вступить.',
    inactiveAlert: 'Ваш статус участника еще не активен, поэтому информация об участниках недоступна.',
    members: 'Участники',
    classmates: 'Одноклассники',
    membersHint: 'Участники класса видят основную информацию о классе и членах.',
    membersOwnerHint: 'Выберите участника, чтобы посмотреть подробную историю обучения.',
    openMemberRecords: 'Посмотреть историю участника',
    joinedAt: 'Вступил: {time}',
    noJoinedAt: 'Время вступления не указано',
    emptyMembers: 'Участников нет',
    learningRecords: 'Учебные записи',
    creatorOnlyStats: 'Учебные записи участников доступны только создателю класса.',
    learningOverview: 'Обзор обучения участников',
    learningOverviewHint: 'Время обучения, упражнения, точность и последнее обучение сгруппированы по участникам.',
    totalStudyTime: 'Общее время обучения',
    totalExercises: 'Всего упражнений',
    averageAccuracy: 'Средняя точность',
    activeLearners: 'Активные участники',
    studyTime: 'Время обучения',
    exerciseSummary: 'Упражнений: {count}, точность {accuracy}',
    activitySummary: 'Слова: {vocab}, диалоги: {dialogue}, игры: {matching}',
    lastStudyAt: 'Последнее обучение: {time}',
    noStudyRecord: 'Нет учебных записей',
    ...
    notifications: {
      ...
      copied: 'Код приглашения скопирован',
      copyFailed: 'Не удалось скопировать. Скопируйте код вручную.'
    },
    statuses: {
      active: 'Активен',
      left: 'Вышел',

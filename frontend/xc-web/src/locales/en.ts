export default {
  ...
  vocab: {
    ...
    pageSummary: 'Page {page} / {pages} · {pageSize} per page · {total} total',
  ...
  membership: {
    ...
    offlineSubtitle: 'WeChat Pay or Alipay is recommended',
    offlineHint: 'After payment, send your account email, plan, and payment screenshot by Telegram, WhatsApp, or VK. We will activate membership after confirmation.',
    offlineMethodsTitle: 'Recommended methods',
    offlineContactTitle: 'Contact for activation',
    offlineQrMissing: 'Contact us to get the payment QR code',
    copyContact: 'Copy',
    contactCopied: 'Contact copied',
    copyFailed: 'Copy failed. Please copy manually.',
    footerTitle: 'Pay offline, then contact us for activation',
    footerSubtitle: 'WeChat Pay and Alipay are supported. You can also reach us by Telegram, WhatsApp, or VK.',
    footerOpenMembership: 'View payment',

export default {
  ...
  vocab: {
    ...
    pageSummary: '第 {page} / {pages} 页 · 每页 {pageSize} 条 · 共 {total} 条',
  ...
  membership: {
    ...
    payWith: '{provider}',
    offlineTitle: '线下支付',
    offlineSubtitle: '推荐使用微信或支付宝付款',
    offlineHint: '付款后请通过 Telegram、WhatsApp 或 VK 发送账号邮箱、套餐和付款截图，人工确认后开通会员。',
    offlineMethodsTitle: '推荐支付方式',
    offlineContactTitle: '联系人工开通',
    offlineQrMissing: '请联系后获取收款码',
    copyContact: '复制',
    contactCopied: '联系方式已复制',
    copyFailed: '复制失败，请手动复制',
    footerTitle: '线下付款后联系人工开通',
    footerSubtitle: '支持微信支付、支付宝，也可以通过 Telegram、WhatsApp、VK 联系。',
    footerOpenMembership: '查看付款',
    checkoutLabel: '开通进度',

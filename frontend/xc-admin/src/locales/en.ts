export default {
  ...
  system: {
    ...
    matchingStages: {
      title: 'Matching / Elimination stages',
      subtitle: 'Configure available stages, pair counts, and multilingual labels for Student Web and H5.',
      add: 'Add stage',
      save: 'Save stages',
      empty: 'No stages',
      code: 'Stage code',
      ...
      sortOrder: 'Order',
      enabled: 'Enabled',
      validationRequired: 'At least one stage is required',
      validationCode: 'Stage code can only contain letters, numbers, underscores, and hyphens, up to 30 characters',
      validationDuplicate: 'Stage code must be unique',
      validationName: 'Please enter the Chinese stage label'
    },
    runtime: {

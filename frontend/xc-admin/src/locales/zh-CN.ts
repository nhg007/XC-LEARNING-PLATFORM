export default {
  ...
  system: {
    ...
    matchingStages: {
      title: '连连看 / 消消乐关卡',
      subtitle: '配置学生端可选择的关卡、配对数量和多语言显示名，保存后学生 Web 与 H5 会使用同一套关卡。',
      add: '新增关卡',
      save: '保存关卡',
      empty: '暂无关卡',
      code: '关卡编码',
      ...
      sortOrder: '排序',
      enabled: '开放',
      validationRequired: '至少需要一个关卡',
      validationCode: '关卡编码只能包含字母、数字、下划线和短横线，最多 30 位',
      validationDuplicate: '关卡编码不能重复',
      validationName: '请填写中文关卡名'
    },
    runtime: {
      title: '运行配置',
